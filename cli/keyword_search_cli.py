...
def main() -> None:
    ...
    idf_parser = subparsers.add_parser("idf",help="Inverse Document Freq")
    idf_parser.add_argument("term",type=str,help="Term to search")

    tfidf_parser = subparsers.add_parser("tfidf", help="Term frequency inverse document freq")
    ...
    match args.command:
        ...
        case "bm25tf":
            bm25_tf = bm25_tf_command(args.doc_id,args.term,args.k2,args.b)
